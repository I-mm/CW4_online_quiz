    ...
    <div id="page-wrapper" class="gray-bg">
        <div class="row border-bottom white-bg">
            <nav class="navbar navbar-expand-lg navbar-static-top" role="navigation">
                ...
                <a href="./home_page.jsp" class="navbar-brand">Tests Make Perfect</a>
                ...
                <div class="navbar-collapse collapse" id="navbar">
                    <ul class="nav navbar-nav mr-auto">
                        <li class="active">
                            <a aria-expanded="false" role="button" href="./home_page.jsp"> Back to main Layout page</a>
                        </li>
                        <li class="dropdown">
        ...
        <div class="wrapper wrapper-content">
                                ...
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content" style="">
                                        <div class="text-center">
                                            ...
                                            %>
                                            Exam ID: <b><%=exam.getExamID()%>
                                        </b><br>
                                            Exam Time:
                                            <b><%=id.substring(0, 4) + "/" + id.substring(4, 6) + "/" + id.substring(6, 8) + " " + id.substring(8, 10) + ":" + id.substring(10, 12) + ":" + id.substring(12, 14)%>
                                            </b><br>
                                            Attempt Times: <b><%= exam.getExamTime()%>
                                        </b><br>
                                            Threshold to Pass: <b><%= exam.getThreshold()%>
                                        </b><br>
                                            Your Mark is <b><%=exam.getScore()%>
                                        </b>/100 here<%=emotion%> You
            ...
            <div class="footer">
                ...
                <div>
                    <strong>Copyright</strong> BUPT TMP
                </div>
            </div>
